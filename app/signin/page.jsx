  ...
  return (
    <>
      {/*
            ...
            ```
          */}
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 h-[calc(100vh-64px)]">
          ...
          <form className="space-y-6" action="#" method="POST">
            ...
            <div>
              <div className="flex items-center justify-between">
                <label
                  htmlFor="password"
                  className="block text-sm px-[10px] outline-none font-medium leading-6 text-gray-900"
                >
                  Password
                </label>
              </div>
