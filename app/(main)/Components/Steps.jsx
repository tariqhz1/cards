...
const cards = [
  ...
  {
    name: "Step 3: Receive Your New Metal Card",
    description:
...
export default function Steps() {
  return (
    <div className="relative isolate overflow-hidden  py-24 sm:py-32 bg-gray-900 m-[0px_14px] md:m-[0px_37px] rounded-[18px]">
      {/* <img
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Transform Your Card in 3 Easy Steps
          </p>
        </div>
