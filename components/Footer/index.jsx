...
const footerNavigation = {
  services: [
    { name: "Pre-Designed Templates", href: "/templates/#pre-designed" },
    { name: "Customizable Templates", href: "/templates/#customizable" },
  ],
  pages: [
    { name: "Templates", href: "/templates" },
    { name: "About Us", href: "/about-us" },
  ],
  about: [{ name: "FAQ", href: "/about-us/#faq" }],
  contact: [
    { name: "+921234567891", href: "#" },
    { name: "personalized@gmail.com", href: "#" },
  ],
                  ...
                  {footerNavigation.services.map((item) => (
                    <li key={item.name}>
                      <span
                        ...
                        className="text-base text-slate-500 hover:text-slate-900 cursor-pointer"
                      >
                        {item.name}
                      </span>
                    </li>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul role="list" className="mt-4 space-y-2 md:space-y-4">
                  {footerNavigation.contact.map((item) => (
                    <li key={item.name}>
                      <span className="text-base text-slate-500 hover:text-slate-900">
                        {item.name}
                      </span>
                    </li>
                  ))}
