...
const Pricing = ({ cardInfo, setcardInfo }) => {
  let { typePrice, surfacePrice, cardPrice, mirrorPrice } = cardInfo;
  return (
    <div className="flex flex-col gap-[10px] md:w-[56%] w-[88%]">
      <div className="flex flex-row gap-[10px] justify-between">
        <p className="text-[15px] text-[rgba(23,23,23,0.5)]">Color</p>
        <p className="text-[15px] text-[rgb(23,23,23)]">+${mirrorPrice} USD</p>
      </div>
      <div className="flex flex-row gap-[10px] justify-between">
      ...
      <div className="flex flex-row gap-[10px] justify-between">
        <p className="text-[15px] text-[rgba(23,23,23,0.5)]">Surface</p>
        <p className="text-[15px] text-[rgb(23,23,23)]">+${surfacePrice} USD</p>
      </div>
      ...
      <div className="flex flex-row gap-[10px] justify-between pt-[10px]">
        ...
        <p className="text-[17px] text-[#23262F] font-bold">
          ${cardPrice + mirrorPrice + surfacePrice + typePrice} USD
        </p>
      </div>
    </div>
  );
